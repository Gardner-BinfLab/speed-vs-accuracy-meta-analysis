...
%1 A meta-analysis of bioinformatics software benchmarks reveals major influences on software accuracy
%2 Analysis of sixty software benchmarks shows the benefits of good software practice 
%3 Assessing the state of the bioinformatic software landscape with a meta-analysis of benchmarks
%4 Sustained software development, not citation metrics, is indicative of accurate bioinformatic software 
%
...
with speed however (see Figure~\ref{fig:allfactors}A \& Supplementary
Figures~\ref{fig:metricPairs} and~\ref{fig:S2}).  We also found that
