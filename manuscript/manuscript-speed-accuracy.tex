...
literature as the ideal tools may fall in the gap e.g. high accuracy is generally not useful if years of CPU time is required, 
while high speed is not useful if the results are very inaccurate.  }
